...
- [Phase 12: Resume most-recently-active Thread across reload](phase-12-resume-last-thread.md) — remember the last-active Thread in localStorage, skip first-run setup on a reload. In progress on `feature/resume-last-thread`.
