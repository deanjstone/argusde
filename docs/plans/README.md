...
- [Phase 4: Checkpoint diff + timeline UI](phase-4-checkpoint-diff-ui.md) — surfaces checkpoint diffing and a timeline strip in the chat view. In progress on `feature/checkpoint-diff-ui`.
