...
- [Phase 10: PWA installability](phase-10-pwa-installability.md) — manifest, icons, and a deliberately non-caching service worker so the shared web UI can be installed on a phone. In progress on `feature/pwa-installability`.
