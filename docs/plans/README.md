...
- [Phase 5: Mode switcher UI](phase-5-mode-switcher-ui.md) — surfaces the agent's mode catalog and lets the user switch modes from the chat view. In progress on `feature/mode-switcher-ui`.
