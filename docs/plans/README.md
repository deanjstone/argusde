...
- [Phase 11: Thread close + worktree auto-cleanup](phase-11-thread-close.md) — close a Thread, tear down its live session, and clean up its worktree from disk. In progress on `feature/thread-close`.
